...
class ValueModel:
    def __init__(self, name, number_of_items, local_bidder_ids, regional_bidder_ids, national_bidder_ids, scaler):
        self.name = name
        self.local_bidder_ids = local_bidder_ids
        self.regional_bidder_ids = regional_bidder_ids
        self.national_bidder_ids = national_bidder_ids
        self.scaler = scaler
        self.M = number_of_items
        self.N = len(local_bidder_ids) + len(regional_bidder_ids) + len(national_bidder_ids)
        self.scaler = scaler
    ...
    def parameters_to_bidder_id(self, NN_parameters):
        return([self._trafo(x) for x in NN_parameters])
